/*
You have an inclusive interval [lower, upper] and a sorted array of unique integers arr[], all of 
which lie within this interval. A number x is considered missing if x is in the range [lower, upper] but not present in arr. 
...
function missingRanges(arr, lower, upper){
	...
	if (lower < arr[0]){
		...
		//check for missing ranges between consequtive elements
	...
	//check for missing ranges after the last element
	...
	console.log(missingRanges([14, 15, 20, 30, 31, 45], 10, 50))
